...
Webquest es una plataforma pedagógica digital diseñada específicamente para la educación primaria en el área de Ciencias Naturales. El sistema facilita la gestión académica permitiendo que los docentes diseñen asignaciones e integren recursos multimedia para optimizar la comprensión cognitiva de los estudiantes.

Filosofía Educativa

El enfoque principal es el aprendizaje híbrido, donde el entorno digital sirve como guía y medio de entrega, pero la ejecución se mantiene en el plano físico (escritura manuscrita en libretas). Esta metodología fomenta la autonomía del estudiante mientras mantiene la conexión con el aprendizaje tradicional.
...
id_usuario	INT (FK)	Referencia a Usuario.id_usuario
pregunta_1-5	VARCHAR	Preguntas de seguridad (5)
...
id_estudiante	INT (FK)	Referencia a Usuario.id_usuario
id_asignatura	INT (FK)	Referencia a Asignaturas.id_asignatura
...
Docente - Asignatura: 1:N (Un docente crea muchas asignaturas)

Asignatura - Recurso: 1:N (Una asignatura tiene múltiples recursos)

Estudiante - Entrega: 1:N (Un estudiante realiza múltiples entregas)

Entrega - Evaluación: 1:1 (Cada entrega genera una evaluación)
...
Escalabilidad: Estructura modular preparada para crecimiento
 ...
 Estado del Proyecto
 Fase completada: Análisis y Requerimientos
 Fase actual: Diseño del Sistema
 Próximas fases: Implementación, Pruebas, Despliegue
...
Documentación actualizada: [2/21/2026]
Versión: 1.0.0
