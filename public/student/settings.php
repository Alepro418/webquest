...
<head>
    ...
    <title>Mi Configuración - Webquest</title>
    <link rel="stylesheet" href="../css/style.css">
    <style>
        /* Estilos específicos para la página de configuración del estudiante */
        .settings-grid {
            display: grid;
...
<body>
                ...
                <div>
                    ...
                    <div class="settings-card">
                        ...
                        <!--<div class="info-badge">
                            <strong>📌 Importante:</strong> Los datos de grado y sección son asignados por tu docente. 
                            Si ves algún error, comunícate con él/ella.
                        </div>-->

                        <div class="form-group">
                            <label for="nombre">Nombre completo</label>
                            <input type="text" id="nombre" value="María García" disabled>
                            <small style="color: #5a7a6a; font-size: 0.8rem;">Este campo no se puede modificar</small>
                        </div>

                        <div class="form-group">
                            <label for="grado">Grado</label>
                            <input type="text" id="grado" value="4to Grado" disabled>
                        </div>

                        <div class="form-group">
                            <label for="seccion">Sección</label>
                            <input type="text" id="seccion" value="A" disabled>
                        </div>

                        <div class="form-group">
                            <label for="numero_lista">Número de lista</label>
                            <input type="text" id="numero_lista" value="#12" disabled>
                        </div>
                ...
                <div>
                    ...
                    <div class="settings-card" style="margin-top: 1.5rem;">
                        ...
                        <div class="toggle-group">
                            <div>
                                <div class="toggle-label">Recordatorios de entregas</div>
                                <div class="toggle-desc">Recibir recordatorio cuando se acerque la fecha límite</div>
                            </div>
                        ...
                        <div class="toggle-group">
                            <div>
                                <div class="toggle-label">Nuevas calificaciones</div>
                                <div class="toggle-desc">Recibir alerta cuando el docente califique una entrega</div>
                            </div>
                            <div class="toggle-switch active" onclick="toggleSwitch(this)">
                                <div class="toggle-slider"></div>
                            </div>
                        ...
                        <div class="toggle-group">
                            <div>
                                <div class="toggle-label">Feedback del docente</div>
                                <div class="toggle-desc">Recibir notificaciones cuando el docente deje comentarios</div>
                            </div>
                    ...
                    <div class="settings-card" style="margin-top: 1.5rem;">
                        ...
                        <div class="toggle-group">
                            <div>
                                <div class="toggle-label">Recordatorios de estudio</div>
                                <div class="toggle-desc">Recibir sugerencias de repaso personalizadas</div>
                            </div>
                            <div class="toggle-switch" onclick="toggleSwitch(this)">
                                <div class="toggle-slider"></div>
                            </div>
                        ...
                        <button class="btn-save" onclick="guardarOpciones()">💾 Guardar preferencias</button>
                    </div>
                </div>
            </div>
        </main>
    ...
    <script>
        ...
        function guardarPerfil() {
            ...
            alert('✅ Datos de perfil guardados (simulación).');
        }
        ...
        function guardarOpciones() {
            ...
            const tema = document.querySelectorAll('.toggle-switch')[3].classList.contains('active') ? 'oscuro' : 'claro';
            const recordatorios = document.querySelectorAll('.toggle-switch')[4].classList.contains('active') ? 'activados' : 'desactivados';
            alert(`✅ Preferencias guardadas:\nIdioma: ${idioma}\nTema: ${tema}\nRecordatorios de estudio: ${recordatorios}`);
        }

        // Inicializar
        document.addEventListener('DOMContentLoaded', function() {
            // Forzar que los toggles no afecten realmente (solo interfaz)
        });
    </script>
</body>
</html>